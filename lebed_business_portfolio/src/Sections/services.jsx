    ...
    <div id="services" className=" shadow-custom-heavy p-4 rounded border-t-1 border-[#695b5b] ">
        ...
        <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <CursorMovement>
                        ...
                        <li class="  p-4 text-center  border-[#0d0d31]-300 bg-[#787586] rounded shadow-md h-[400px] w-[300px] sm:text-[10px]">
                    <img src={orth_image} alt = "" class = "w-[200px] h-[220px] mx-auto sm:w-[180px] sm:h-[180px]" />
                    <h2 class = "my-2 text-[#f9f871] font-semibold sm:text-xl"> Orthopedic Physiotherapy </h2>
                    <p class=" leading-5 text-[13px] sm:text-[15px] my-3" >
                ...
                <div className="service2">
                        ...
                        <img src={geretric_img} alt = "" class = "w-[200px] h-[200px] mx-auto sm:w-[180px] sm:h-[180px]" />
                        <h2 class = " my-2 text-[#f9f871] font-semibold sm:text-xl">Geriatric Physiotherapy </h2>
                        <p class=" leading-5 text-[13px] sm:text-[15px] my-3">Management of age-related conditions like osteoporosis, arthritis, and balance issues.
           ...
           <CursorMovement>
                <div className="service3">
                                <li class=" p-4 text-center  border-[#0d0d31]-300 bg-[#787586] rounded shadow-md h-[400px] w-[300px]">
                                <img src={pediatric_img} alt = "" class = "w-[200px] h-[220px] mx-auto sm:w-[180px] sm:h-[180px] " />
            ...
            <CursorMovement>
                <div className="service4">
                                <li class=" p-4 text-center  border-[#0d0d31]-300 bg-[#787586] rounded shadow-md h-[400px] w-[300px]">
                                <img src={neuro_img} alt = "" class = "w-[200px] h-[200px] mx-auto  sm:w-[180px] sm:h-[180px]  " />
                                <h2  class = "my-2 text-[#f9f871] font-semibold sm:text-xl" >Neuro Physiotherapy</h2>
                                <p class=" leading-5 text-[13px] sm:text-[15px] my-3"> <span class="font-bold">Stroke recovery</span>, focusing on improving mobility and independence.
            ...
            <CursorMovement>
                <div className="service5">
                                <li class=" p-4 text-center  border-[#0d0d31]-300 bg-[#787586] rounded shadow-md h-[400px] w-[300px]">
                                <img src={sports_phys} alt = "" class = "w-[200px] h-[200px] mx-auto  sm:w-[180px] sm:h-[180px]  " />
            ...
            <CursorMovement>
                <div className="service4">
                                <li class=" p-4 text-center  border-[#0d0d31]-300 bg-[#787586] rounded shadow-md h-[400px] w-[300px]">
                                <img src={chest_phys} alt = "" class = "w-[200px] h-[200px] mx-auto  sm:w-[180px] sm:h-[180px] " />
